...
def simulate_with_trajectory(data, alpha_value, initial_position=None, duration=None):
    """
    ...
    for data_idx in range(duration):
        ...
        velocityInput = alpha_value * velocity / 1000.0
...
def optimize_alpha_for_velocity(args):
    """Helper function for parallel processing to optimize only alpha (velocity only)"""
    ...
    return velocity, optimal_alpha, mse, len(trajectory_segments)
