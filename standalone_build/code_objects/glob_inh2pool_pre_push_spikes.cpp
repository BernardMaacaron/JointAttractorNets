...
void _run_glob_inh2pool_pre_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_glob_inh2pool_delay.size();
    ...
    {
        glob_inh2pool_pre.advance();
        glob_inh2pool_pre.push(_ptr_array_glob_inh_neuron__spikespace, _ptr_array_glob_inh_neuron__spikespace[_num_spikespace-1]);
    }
