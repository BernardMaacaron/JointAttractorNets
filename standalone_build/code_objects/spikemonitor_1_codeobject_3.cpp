...
void _run_spikemonitor_1_codeobject_3()
{
...
const size_t _num_source_idx = 1;
    ...
    int32_t*   _ptr_array_glob_inh_neuron_i = _array_glob_inh_neuron_i;
    int32_t* __restrict  _ptr_array_glob_inh_neuron__spikespace = _array_glob_inh_neuron__spikespace;
    int32_t*   _ptr_array_spikemonitor_1_count = _array_spikemonitor_1_count;
    ...
    int32_t*   _ptr_array_spikemonitor_1__source_idx = _array_spikemonitor_1__source_idx;


    //// MAIN CODE ////////////

    int32_t _num_events = _ptr_array_glob_inh_neuron__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_glob_inh_neuron__spikespace[_j];
        ...
        if (_num_events > 0) {
            ...
            {
                const size_t _idx = _ptr_array_glob_inh_neuron__spikespace[_j];
                const size_t _vectorisation_idx = _idx;
                                
                const int32_t _source_i = _ptr_array_glob_inh_neuron_i[_idx];
...
void _debugmsg_spikemonitor_1_codeobject_3()
{
    using namespace brian;
    const size_t _numN = 1;
const size_t _num_clock_t = 1;
