...
void _run_pool2glob_inh_pre_codeobject_2()
{
...
double* const _array_pool2glob_inh_w_exc = _dynamic_array_pool2glob_inh_w_exc.empty()? 0 : &_dynamic_array_pool2glob_inh_w_exc[0];
const size_t _numw_exc = _dynamic_array_pool2glob_inh_w_exc.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_pool2glob_inh__synaptic_post.size();
    ///// POINTERS ////////////
        
    double*   _ptr_array_glob_inh_neuron_I_syn = _array_glob_inh_neuron_I_syn;
    int32_t* __restrict  _ptr_array_pool2glob_inh__synaptic_pre = _array_pool2glob_inh__synaptic_pre;
    double* __restrict  _ptr_array_pool2glob_inh_w_exc = _array_pool2glob_inh_w_exc;
    ...
    {
    std::vector<int> *_spiking_synapses = pool2glob_inh_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const int32_t _postsynaptic_idx = _ptr_array_pool2glob_inh__synaptic_post[_idx];
            double I_syn_post = _ptr_array_glob_inh_neuron_I_syn[_postsynaptic_idx];
            const double w_exc = _ptr_array_pool2glob_inh_w_exc[_idx];
            I_syn_post += w_exc;
            _ptr_array_glob_inh_neuron_I_syn[_postsynaptic_idx] = I_syn_post;
...
void _debugmsg_pool2glob_inh_pre_codeobject_2()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_pool2glob_inh__synaptic_pre.size() << endl;
}
