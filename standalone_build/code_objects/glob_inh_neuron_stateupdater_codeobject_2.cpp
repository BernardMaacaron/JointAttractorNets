...
void _run_glob_inh_neuron_stateupdater_codeobject_2()
{
    ...
    ///// CONSTANTS ///////////
    const size_t _numI_ext = 1;
const size_t _numI_syn = 1;
const size_t _numI_vel = 1;
const int64_t N = 1;
...
const double uvolt = 1e-06;
    ...
    double*   _ptr_array_glob_inh_neuron_I_ext = _array_glob_inh_neuron_I_ext;
    double*   _ptr_array_glob_inh_neuron_I_syn = _array_glob_inh_neuron_I_syn;
    double*   _ptr_array_glob_inh_neuron_I_vel = _array_glob_inh_neuron_I_vel;
    double*   _ptr_array_glob_inh_neuron_V = _array_glob_inh_neuron_V;
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    double*   _ptr_array_glob_inh_neuron_lastspike = _array_glob_inh_neuron_lastspike;
    char*   _ptr_array_glob_inh_neuron_not_refractory = _array_glob_inh_neuron_not_refractory;
    ...
    const double _lio_5 = 1.0f*(31.6227766016838 * uvolt)/(_brian_pow(msecond, 0.5));
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double I_ext = _ptr_array_glob_inh_neuron_I_ext[_idx];
        const double I_syn = _ptr_array_glob_inh_neuron_I_syn[_idx];
        const double I_vel = _ptr_array_glob_inh_neuron_I_vel[_idx];
        double V = _ptr_array_glob_inh_neuron_V[_idx];
        const double lastspike = _ptr_array_glob_inh_neuron_lastspike[_idx];
        char not_refractory = _ptr_array_glob_inh_neuron_not_refractory[_idx];
        ...
        if(not_refractory)
            V = _V;
        _ptr_array_glob_inh_neuron_V[_idx] = V;
        _ptr_array_glob_inh_neuron_not_refractory[_idx] = not_refractory;
