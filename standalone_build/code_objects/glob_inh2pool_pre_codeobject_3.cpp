...
void _run_glob_inh2pool_pre_codeobject_3()
{
...
double* const _array_glob_inh2pool_w_inh = _dynamic_array_glob_inh2pool_w_inh.empty()? 0 : &_dynamic_array_glob_inh2pool_w_inh[0];
const size_t _numw_inh = _dynamic_array_glob_inh2pool_w_inh.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_glob_inh2pool__synaptic_post.size();
    ///// POINTERS ////////////
    ...
    double* __restrict  _ptr_array_glob_inh2pool_w_inh = _array_glob_inh2pool_w_inh;
    ...
    {
    std::vector<int> *_spiking_synapses = glob_inh2pool_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const int32_t _postsynaptic_idx = _ptr_array_glob_inh2pool__synaptic_post[_idx];
            double I_syn_post = _ptr_array_ring_neurons_I_syn[_postsynaptic_idx];
            const double w_inh = _ptr_array_glob_inh2pool_w_inh[_idx];
            I_syn_post += w_inh;
...
void _debugmsg_glob_inh2pool_pre_codeobject_3()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_glob_inh2pool__synaptic_pre.size() << endl;
}
