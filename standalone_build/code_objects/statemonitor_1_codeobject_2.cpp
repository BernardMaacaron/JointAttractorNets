...
void _run_statemonitor_1_codeobject_2()
{
...
const size_t _num_source_I_ext = 120;
...
const size_t _numt = _dynamic_array_statemonitor_1_t.size();
    ...
    _dynamic_array_statemonitor_1_I_ext.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const double _source_I_ext = _ptr_array_ring_neurons_I_ext[_idx];
        const double _to_record_I_ext = _source_I_ext;


        _dynamic_array_statemonitor_1_I_ext(_new_size-1, _i) = _to_record_I_ext;
    }
