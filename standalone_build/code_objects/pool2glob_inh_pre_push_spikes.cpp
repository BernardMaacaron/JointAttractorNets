...
void _run_pool2glob_inh_pre_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_pool2glob_inh_delay.size();
    ...
    {
        pool2glob_inh_pre.advance();
        pool2glob_inh_pre.push(_ptr_array_ring_neurons__spikespace, _ptr_array_ring_neurons__spikespace[_num_spikespace-1]);
    }
